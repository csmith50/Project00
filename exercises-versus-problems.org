...
WOT I LEARNED:
A problem is a conflict which does not necesarily have an answer. It is your job to come up with an answer.
A problem could also have multiple answers, some better than others. 
An excercise is a conclict which has an agreed upon answer and finding that answer is just a matter of taking the correct
path. Clearly problem's are more exciting and certainly more challenging. To become a problem solver takes dedication and
practice. Most anyone can perform excercises but not all can be great problem solvers.
